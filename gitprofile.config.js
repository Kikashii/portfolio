...
const config = {
  github: {
    ...
    exclude: {
      ...
      projects: ['mmm','lg','portfolio'], // These projects will not be displayed. example: ['my-project1', 'my-project2']
    },
  },
  social: {
  ...
  blog: {
    ...
    username: 'Rafid Nahiyan Farabi', // to hide blog section, keep it empty
